    ...
    return (
        <div className="h-full flex flex-col gap-3 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col gap-3 min-h-0 overflow-y-auto scrollbar-hide ">
                ...
                <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-[#2d4a6f] to-[#1a2942] flex-shrink-0 z-1000">
                    <img src="/images/panda-wallet.png" alt="Panda Wallet" className="size-25 flex-shrink-0 object-contain" />
                ...
                <CardFrame size="sm" className=" mx-4 my-2">
                ...
                <CardFrame size="sm" className="flex-shrink-0 mx-4">
                    <div className="p-3 bg-[#2d4a6f] space-y-3">
                        {/* QR Code */}
                        <div className="bg-white rounded-xl p-3 flex items-center justify-center">
                            <div className="w-32 h-32 rounded-lg flex items-center justify-center">
                                <img src="/images/panda-qr.png" alt="Panda QR" className="w-full h-full object-contain" />
                            </div>
                        </div>
