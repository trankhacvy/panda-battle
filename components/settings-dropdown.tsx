...
export function SettingsDropdown() {
  ...
  const { isMuted, isMusicEnabled, toggleMute, toggleMusic } = useSoundStore();
      ...
      >
        ...
        >
          <div className="relative">
            <Volume2
              className={cn("size-4 transition-colors text-white")}
              strokeWidth={3}
            />
            {isMuted && (
        ...
        <IconButton
          ...
          variant={!isMusicEnabled ? "destructive" : "secondary"}
          size="sm"
        >
          <div className="relative">
            <Music
